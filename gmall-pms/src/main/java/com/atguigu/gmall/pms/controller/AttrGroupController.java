...
public class AttrGroupController {
    ...
    public Resp<List<ItemGroupVo>> queryItemGroupVoByCidAndSpuId(@PathVariable("cid")Long cid,@PathVariable("spuId")Long spuId){
        List<ItemGroupVo> list = attrGroupService.queryItemGroupVoByCidAndSpuId(cid,spuId);
        return Resp.ok(list);
    }
    ...
    @GetMapping("{cid}")
    public Resp<PageVo> queryByCidPage(@PathVariable(value = "cid")Long cid, QueryCondition condition){
